...
df_train = pd.read_csv(r'C:\Users\hempe\Studium\Real_Project\Project_repo\data\raw\all_features_train_data.csv')
...
# Make sure new column names are lower case a
...
# 
print(df_test_processed.shape)  # Display the shape of the preprocessed DataFrame
print(df_train_processed.shape)  # Display the shape of the preprocessed DataFrame
